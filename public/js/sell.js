...
(function () {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const ruleCheckboxes = Array.from(form.querySelectorAll('[data-rule-checkbox]'));
    ...
    if (ruleCheckboxes.length && !ruleCheckboxes.every((cb) => cb.checked)) {
      KENARRZ.toast('Kamu harus mencentang semua persetujuan Rules Jual Akun sebelum mengirim.', 'error');
      return;
    }
